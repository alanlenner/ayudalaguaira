...
CREATE TABLE IF NOT EXISTS desaparecidos (
  ...
  zona TEXT NOT NULL CHECK (zona IN ('Naiguatá', 'Caraballeda', 'Catia La Mar', 'Maiquetía', 'Tanaguarena', 'Macuto', 'Centro Pérez Carreño')),
...
-- ALTER TABLE desaparecidos ADD CONSTRAINT desaparecidos_zona_check CHECK (zona IN ('Naiguatá', 'Caraballeda', 'Catia La Mar', 'Maiquetía', 'Tanaguarena', 'Macuto', 'Centro Pérez Carreño'));
